      ...
      <section className="border-t py-16">
        <div className="container mx-auto px-3">
          ...
          <div className="mx-auto flex flex-col md:flex-row md:justify-center gap-8 max-w-5xl">
            <Link href="/team/mithilesh-kumar" className="w-full flex justify-start md:justify-center md:flex-1 min-w-[220px] max-w-xs">
              <TeamMemberCard
            ...
            <Link href="/team/dr-anisha" className="w-full flex justify-start md:justify-center md:flex-1 min-w-[220px] max-w-xs">
              <TeamMemberCard
                name="Dr. Anisha"
                role="Co-founder"
            ...
            <Link href="/team/arif-mudgal" className="w-full flex justify-start md:justify-center md:flex-1 min-w-[220px] max-w-xs">
              <TeamMemberCard
                name="ARIF MUDGAL"
                role="Member"
            ...
            <Link href="/team/capt-santhosh" className="w-full flex justify-start md:justify-center md:flex-1 min-w-[220px] max-w-xs">
              <TeamMemberCard
